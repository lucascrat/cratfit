...
export const exerciseDatabase = {
    ...
    ombros: [
        ...
        { id: 'desenvolvimento_maquina', name: 'Desenvolvimento na Máquina', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'ombros', secondaryMuscles: ['tríceps'], gif: 'exercises/1768273097703_Desenvolvimento-de-ombro-na-maquina.gif', description: 'Movimento guiado para desenvolvimento de ombros.' },
        ...
        { id: 'elevacao_lateral', name: 'Elevação Lateral', equipment: 'halteres', difficulty: 'iniciante', primaryMuscle: 'ombros', secondaryMuscles: [], gif: 'exercises/1768273189810_elevacao-letaral-com-haltrers.gif', description: 'Eleve os halteres lateralmente até a altura dos ombros.' },
        { id: 'elevacao_lateral_maquina', name: 'Elevação Lateral Máquina', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'ombros', secondaryMuscles: [], gif: 'exercises/1768273182145_Elevacao-lateral-na-maquina.gif', description: 'Elevação lateral na máquina para deltoides.' },
        { id: 'elevacao_frontal', name: 'Elevação Frontal', equipment: 'halteres', difficulty: 'iniciante', primaryMuscle: 'ombros', secondaryMuscles: [], gif: 'exercises/1768273155110_elevacao-frontal-com-halteres.gif', description: 'Eleve o halter à frente até altura do ombro.' },
        { id: 'elevacao_frontal_barra', name: 'Elevação Frontal com Barra', equipment: 'barra', difficulty: 'iniciante', primaryMuscle: 'ombros', secondaryMuscles: [], gif: 'exercises/1768273146563_Elevacao-Frontal-com-Barra.gif', description: 'Eleve a barra à frente trabalhando deltoides anterior.' },
        ...
        { id: 'elevacao_lateral_cabo', name: 'Elevação Lateral com Cabo', equipment: 'cabo', difficulty: 'intermediario', primaryMuscle: 'ombros', secondaryMuscles: [], gif: 'exercises/1768273196367_elevacao-unilateral-no-cross.gif', description: 'Elevação lateral unilateral no cross over.' },
    ],
    ...
    triceps: [
        ...
        { id: 'triceps_frances', name: 'Tríceps Francês com Halter', equipment: 'halteres', difficulty: 'intermediario', primaryMuscle: 'tríceps', secondaryMuscles: [], gif: 'exercises/1768273813636_Tríceps-Frances-com-Halteres.gif', description: 'Halter atrás da cabeça, extensão dos braços.' },
        ...
        { id: 'triceps_maquina', name: 'Tríceps na Máquina', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'tríceps', secondaryMuscles: [], gif: 'exercises/1768273737400_Extensao-de-tríceps-na-máquina.gif', description: 'Extensão guiada na máquina.' },
    ],
    ...
    pernas: [
        ...
        { id: 'adutora', name: 'Máquina Adutora', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'pernas', secondaryMuscles: [], gif: 'exercises/1768273599214_Maquina-de-Adução-de-Quadril.gif', description: 'Trabalha a parte interna das coxas.' },
    ],

    gluteos: [
        { id: 'elevacao_pelvica', name: 'Elevação Pélvica com Barra', equipment: 'barra', difficulty: 'intermediario', primaryMuscle: 'glúteos', secondaryMuscles: ['pernas'], gif: 'exercises/1768272935001_Elevacao-Pelvica-Com-Barra.gif', description: 'Hip thrust, melhor exercício para glúteos.' },
        { id: 'elevacao_pelvica_maquina', name: 'Elevação Pélvica na Máquina', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'glúteos', secondaryMuscles: [], gif: 'exercises/1768272937950_Elevacao-Pelvica-Na-Maquina.gif', description: 'Hip thrust guiado na máquina.' },
        { id: 'gluteo_maquina', name: 'Glúteo na Máquina', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'glúteos', secondaryMuscles: [], gif: 'exercises/1768272955410_Gluteo-Coice-Na-Máquina.gif', description: 'Coice de glúteo na máquina.' },
        { id: 'gluteo_polia', name: 'Glúteo na Polia', equipment: 'cabo', difficulty: 'intermediario', primaryMuscle: 'glúteos', secondaryMuscles: [], gif: 'exercises/1768272960642_Gluteos-na-Polia-Baixa.gif', description: 'Extensão de quadril no cross over.' },
        { id: 'abdutora', name: 'Máquina Abdutora', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'glúteos', secondaryMuscles: [], gif: 'exercises/1768272962166_Maquina-de-Abducao-de-Quadril.gif', description: 'Abre as pernas trabalhando glúteo médio.' },
        ...
        { id: 'extensao_quadril_cabo', name: 'Extensão de Quadril com Cabo', equipment: 'cabo', difficulty: 'intermediario', primaryMuscle: 'glúteos', secondaryMuscles: [], gif: 'exercises/1768272947734_Extensao-de-Quadril-com-Cabo.gif', description: 'Extensão de quadril unilateral.' },
    ],
    ...
    abdomen: [
        ...
        { id: 'abdominal_polia', name: 'Abdominal na Polia', equipment: 'cabo', difficulty: 'intermediario', primaryMuscle: 'abdômen', secondaryMuscles: [], gif: 'exercises/1768272240456_Abdominal-Crunch-na-Polia-Alta-em-pe-Executado-no-cross-over.gif', description: 'Ajoelhado, puxe a corda para baixo.' },
        { id: 'abdominal_infra', name: 'Abdominal Infra', equipment: 'corpo', difficulty: 'intermediario', primaryMuscle: 'abdômen', secondaryMuscles: [], gif: 'exercises/1768272248899_Abdominal-Infra-no-Solo-Elevacao-de-Pernas.gif', description: 'Elevação de pernas focando parte inferior.' },
        ...
        { id: 'obliquo', name: 'Abdominal Oblíquo', equipment: 'corpo', difficulty: 'intermediario', primaryMuscle: 'abdômen', secondaryMuscles: [], gif: 'exercises/1768272253346_Abdominal-Obliquo-Cruzado-(unilateral).gif', description: 'Rotação do tronco para trabalhar os oblíquos.' },
    ...
    cardio: [
        { id: 'esteira', name: 'Esteira Ergométrica', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'cardio', secondaryMuscles: ['pernas'], gif: 'exercises/1768272726965_Esteira-Ergometrica.gif', description: 'Caminhada ou corrida na esteira.' },
        { id: 'esteira_inclinada', name: 'Esteira Inclinada', equipment: 'maquina', difficulty: 'intermediario', primaryMuscle: 'cardio', secondaryMuscles: ['pernas', 'glúteos'], gif: 'exercises/1768272724594_Esteira-com-Inclinacao.gif', description: 'Caminhada em inclinação para maior intensidade.' },
        ...
        { id: 'eliptico', name: 'Elíptico', equipment: 'maquina', difficulty: 'iniciante', primaryMuscle: 'cardio', secondaryMuscles: ['pernas', 'braços'], gif: 'exercises/1768272734532_Máquina-Eliptica.gif', description: 'Movimento completo de baixo impacto.' },
        { id: 'simulador_escada', name: 'Simulador de Escada', equipment: 'maquina', difficulty: 'intermediario', primaryMuscle: 'cardio', secondaryMuscles: ['pernas', 'glúteos'], gif: 'exercises/1768272733144_Maquina-Simulador-Escada.gif', description: 'Suba escadas sem parar.' },
